...
<head>
    <title>Way Error Page Form Responsive Widget Template :: w3layouts</title>
    <!-- Meta-Tags -->
    ...
    <!-- Stylesheets -->
    <link href="/errors/css/style.css" rel='stylesheet' type='text/css' />
    <!--// Stylesheets -->
    <!-- online fonts -->
...
*/
        ...
        body {
            ...
            font-size: 100%;
            background: url(../errors/images/banner2.jpg)no-repeat center;
...
<div class="copy-wthree">
    <p>© 2018 Way Error Page. All Rights Reserved | Design by
